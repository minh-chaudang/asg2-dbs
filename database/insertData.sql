...
INSERT INTO Person VALUES (2001, 'Nguyen Dang Minh', '056202111222', CONVERT(date, '22-05-2002', 105),'Thu Duc', 'minhcute', '1234abdc', 0, 1, 0, null, null);
INSERT INTO Person VALUES (2002, 'Phan Quoc Bao', '991201111733', CONVERT(date, '12-03-2001', 105),'Quan 9', 'bao1103', 'ok123zoko', 0, 1, 0, null, null);
INSERT INTO Person VALUES (2003, 'Chu Dinh Chien', '345202111666', CONVERT(date, '26-04-2002', 105),'Binh Duong', 'Chienquatroi', 'chien5678', 0, 1, 0, null, null);
...
INSERT INTO Person VALUES (3001, 'Nguyen Cong Le', '345098123234', CONVERT(date, '05-07-1998', 105),'Quan 9', 'Conlehehe', '1234ghjk', 0, 0, 1, null, 'Quan Ly');
...
INSERT INTO Person VALUES (3003, 'Nguyen Thanh Cong', '006782734234', CONVERT(date, '27-05-1980', 105),'Bien Hoa', 'Cong147', 'ddjd90032', 0, 0, 1, null, 'Thu Ngan');
INSERT INTO Person VALUES (3004, 'Trinh Hai Yen', '900203881290', CONVERT(date, '30-04-1979', 105),'Thu Duc', 'Yendangbay', 'hdj89765', 0, 0, 1, null, 'Quan Ly');
...
INSERT INTO Course VALUES (550, 'Toeic 550', 1001, CONVERT(date, '22-12-2022', 105), CONVERT(date, '22-05-2023', 105), 9000000, 10);
INSERT INTO Course VALUES (55, 'Ielts 5.5', 1002, CONVERT(date, '1-1-2023', 105), CONVERT(date, '01-06-2023', 105), 15000000, 20);
INSERT INTO Course VALUES (75, 'Ielts 7.5', 1003, CONVERT(date, '3-1-2023', 105), CONVERT(date, '03-08-2023', 105), 20000000, 10);
INSERT INTO Course VALUES (53, 'Toeic 600', 1002, CONVERT(date, '1-4-2023', 105), CONVERT(date, '1-6-2023', 105), 1000000, 15);
INSERT INTO Course VALUES (22, 'Toeic 750', 1001, CONVERT(date, '22-1-2022', 105), CONVERT(date, '22-4-2022', 105), 15000000, 25);
INSERT INTO Course VALUES (34, 'Ielts 5.5', 1003, CONVERT(date, '5-3-2023', 105), CONVERT(date, '5-6-2023', 105), 20000000, 20);
INSERT INTO Course VALUES (67, 'Toeic 600', 1001, CONVERT(date, '10-12-2022', 105), CONVERT(date, '10-3-2023', 105), 15000000, 20);
INSERT INTO Course VALUES (89, 'Toeic 550', 1002, CONVERT(date, '6-10-2022', 105), CONVERT(date, '6-6-2023', 105), 20000000, 10);
